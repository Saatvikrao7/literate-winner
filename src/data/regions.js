...
export const REGIONS = [
  {
    ...
    name: 'Global',
    tag: null, query: null,
    center: { lat: 20, lng: 0, altitude: 2.5 },
    color: '#6366f1', activeColor: '#818cf8',
  },
  {
    id: 'north-america',
    name: 'North America',
    ...
    center: { lat: 40, lng: -100, altitude: 1.8 },
    color: '#ef4444', activeColor: '#f87171',
  },
  {
    id: 'south-america',
    name: 'South America',
    ...
    center: { lat: -15, lng: -60, altitude: 1.8 },
    color: '#f97316', activeColor: '#fb923c',
  },
  {
    id: 'europe',
    name: 'Europe',
    tag: 'world/europe-news', query: null,
    center: { lat: 52, lng: 15, altitude: 1.5 },
    color: '#eab308', activeColor: '#facc15',
  },
  {
    id: 'russia',
    name: 'Russia / CIS',
    tag: 'world/russia', query: null,
    center: { lat: 62, lng: 80, altitude: 1.8 },
    color: '#dc2626', activeColor: '#ef4444',
  },
  {
    id: 'middle-east',
    name: 'Middle East',
    tag: 'world/middleeast', query: null,
    center: { lat: 28, lng: 42, altitude: 1.5 },
    color: '#d97706', activeColor: '#f59e0b',
  },
  {
    id: 'africa',
    name: 'Africa',
    tag: 'world/africa', query: null,
    center: { lat: 5, lng: 20, altitude: 1.8 },
    color: '#16a34a', activeColor: '#22c55e',
  },
  {
    id: 'south-asia',
    name: 'South Asia',
    ...
    center: { lat: 22, lng: 78, altitude: 1.6 },
    color: '#0891b2', activeColor: '#06b6d4',
  },
  {
    id: 'east-asia',
    name: 'East Asia',
    ...
    center: { lat: 36, lng: 116, altitude: 1.6 },
    color: '#7c3aed', activeColor: '#8b5cf6',
  },
  {
    id: 'southeast-asia',
    name: 'SE Asia',
    ...
    center: { lat: 5, lng: 112, altitude: 1.6 },
    color: '#0e7490', activeColor: '#0891b2',
  },
  {
    id: 'oceania',
    name: 'Oceania',
    ...
    center: { lat: -25, lng: 135, altitude: 1.8 },
    color: '#059669', activeColor: '#10b981',
  },
];
